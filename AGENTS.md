# AGENTS.md — RoeBux Storefront

Instructions for Codex working in this repository. Read this first, every session.
...
## Working rhythm
1. Read `AGENTS.md`, `docs/ROEBUX_CUSTOMER_PRD.md`, `docs/ROEBUX_HORIZON_IMPLEMENTATION_CHECKLIST_v0.2.md`, and `docs/ROEBUX_HOMEPAGE_DESIGN_DIRECTION.md` before coding.
